...
class PropellerServerNode(Node):  # MODIFY NAME
    def __init__(self):
        super().__init__("propeller_server")  # MODIFY NAME
        self.goal_handle_: ServerGoalHandle = None
        self.goal_lock_ = threading.Lock()

        # Acción del servidor
        self.propeller_server_ = ActionServer(
            self,
            AiapaecPropeller, 
            "aiapaec_propeller", 
        ...
        self.tp1_publisher_ = self.create_publisher(Int16, "right_propeller", 10)
        self.tp2_publisher_ = self.create_publisher(Int16, "left_propeller", 10)
    ...
    def execute_callback(self, goal_handle: ServerGoalHandle):
        ...
        while rclpy.ok():
            if not goal_handle.is_active:
                result.tp1_result = tp1
                result.tp2_result = tp2
                return result
            ...
            feedback.tp1_feedback = tp1  # Modificar
            feedback.tp2_feedback = tp2  # Modificar
...
def main(args=None):
    ...
    node = PropellerServerNode()  # MODIFY NAME
